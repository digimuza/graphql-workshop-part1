...
import { DrumUpsertWithoutDrumStateHistoryUpdatesInput } from "../inputs/DrumUpsertWithoutDrumStateHistoryUpdatesInput";
import { DrumWhereUniqueInput } from "../inputs/DrumWhereUniqueInput";

@TypeGraphQL.InputType({
  isAbstract: true
})
export class DrumUpdateOneRequiredWithoutDrumStateHistoryUpdatesInput {
  ...
  @TypeGraphQL.Field(_type => DrumUpsertWithoutDrumStateHistoryUpdatesInput, {
    nullable: true
  })
  upsert?: DrumUpsertWithoutDrumStateHistoryUpdatesInput | undefined;
  ...
  update?: DrumUpdateWithoutDrumStateHistoryUpdatesInput | undefined;
}
